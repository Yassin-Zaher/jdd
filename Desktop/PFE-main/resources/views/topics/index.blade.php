...
@section('content')
<section style="margin-left: 190px" class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="flex-1 flex items-center space-x-2">
                    <h5>
                        <span class="text-gray-500">@lang('quickadmin.topics.title')</span>
         ...
         <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 border-t dark:border-gray-700">
            ...
            <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    ...
                    <a href="{{ route('topics.create') }}">
                        <button class="flex items-center  justify-center text-white bg-indigo-500 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800">

                            <svg class="h-3.5 w-3.5 mr-1.5 -ml-1" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path clip-rule="evenodd" fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" />
                            </svg>
                            <span>Ajouter un neuvaux module</span> 
                        </button>
                    </a>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 {{ count($topics) > 0 ? 'datatable' : '' }} dt-select">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th style="text-align:center;"><input type="checkbox" id="select-all" /></th>
                        <th scope="col" class="px-6 py-3" >@lang('quickadmin.topics.fields.title')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    @if (count($topics) > 0)
                        @foreach ($topics as $topic)
                            ...
                            <tr data-entry-id="{{ $topic->id }}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td></td>
                                <td>{{ $topic->title }}</td>
                                <td>
